...
def inject_css() -> None:
    st.markdown(
        ...
        /* MOBILE: la navegación compacta desaparece por completo para no cubrir el dashboard. */
        @media(max-width:768px){
            ...
            /* Ocultar de forma robusta la rail RES / ORD / REC / MOV... */
            .sidebar-rail,
            aside.sidebar-rail,
            ...
            /* Dejar solamente el control nativo de Streamlit para abrir el menú completo. */
            [data-testid="stSidebarCollapsedControl"],
            [data-testid="collapsedControl"] {
                left:8px!important;
                top:78px!important;
